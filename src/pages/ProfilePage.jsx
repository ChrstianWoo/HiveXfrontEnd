...
export const ProfilePage = () => {
  const initialProfile = {
    ...
    currentAddress: '3 Banksia St, Botany NSW 2019',
    permanentAddress: '1443 Botany Rd, Botany NSW 2019',
          ...
          <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center">
            ...
            <div className="relative bg-white w-full md:w-96 p-6 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="flex justify-center">
                <a href="https://wa.me/?text=I'm%20inviting%20you%20to%20join%20HiveX">
                  <svg
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://your-website-url.com">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5"
                    fill="currentColor"
                ...
                <a href="https://www.reddit.com/submit?url=https://your-website-url.com&title=Join%20HiveX">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5"
                    fill="currentColor"
