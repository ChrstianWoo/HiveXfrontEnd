  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-white rounded-lg shadow-lg">
      <div className="flex justify-between items-center mb-4">
        <div className="text-2xl font-bold mb-4">Shanghai Dumpling</div>
        <img src="/assets/Shanghai Dumpling Bar.png" alt="Shanghai Dumpling Bar Logo" className="w-16 h-16 rounded-full" />
      </div>
