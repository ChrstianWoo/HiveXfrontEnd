  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center pt-4">
      ...
      <div className="flex flex-col items-center px-4 w-full max-w-md mx-auto">
        <div className="text-center uppercase font-bold text-base mt-4">HIVE X - Broker</div>

        <div className="my-4 p-2 border rounded-lg w-full text-center text-sm">Member Mode</div>
